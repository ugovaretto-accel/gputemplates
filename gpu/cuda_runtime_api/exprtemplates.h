...
#define DEF_ONE_OPERAND_OPERATOR( OPERATOR__, OPERATION__ ) \
    ...
    /*inline*/ CUDAAPI OneOpExpression< OPERATION__, OPERAND >  operator OPERATOR__( const Expr< OPERAND >& operand ) \
    { \
...
#define DEF_ONE_OPERAND_FUNCTION( FUNCTION__, FUNCTION_NAME__ ) \
    ...
    /*inline*/ CUDAAPI FunExpression< FUNCTION__, OPERAND >  FUNCTION_NAME__( const Expr< OPERAND >& operand ) \
    { \
